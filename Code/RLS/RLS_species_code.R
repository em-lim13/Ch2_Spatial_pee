...
rls_hell <- rls %>%
  mutate(
    mass = case_when(Species == "Mesocentrotus franciscanus" ~ 300,
                  Species == "Pomaulax gibberosus" ~ 60,
                  Species == "Patiria miniata" ~ 60,
                  Species == "Rhinogobiops nicholsii" ~ 6,
                  Species == "Apostichopus californicus"~  695,
                  Species == "Haliotis kamtschatkana" ~ 200,
                  Species == "Acmaea mitra" ~ 8,
                  Species == "Ceratostoma foliatum" ~ 14,
                  Species == "Orthasterias koehleri" ~ 25,
                  Species == "Dermasterias imbricata" ~ 60,
                  Species == "Paguroidea spp." ~ 6,
                  Species == "Strongylocentrotus purpuratus" ~ 70,
                  Species == "Pisaster ochraceus" ~ 100, # top 16 inverts
                  Species == "Hexagrammos decagrammus" ~ 600,
                  Species == "Sebastes flavidus" ~ 1500,
                  Species == "Sebastes melanops" ~ 1500,
                  Species == "Sebastes caurinus" ~ 1500,
                  Species == "Sebastes maliger" ~ 1500,
                  Species == "Sebastes nebulosus" ~ 1500,
                  Species == "Sebastes spp. juv" ~ 100,
                  Species == "Jordania zonope" ~ 10,
                  Species == "Artedius harringtoni" ~ 10,
                  Species == "Embiotoca lateralis" ~ 750,
                  Species == "Oxylebius pictus" ~ 500,
                  Species == "Rhacochilus vacca" ~ 500,
                  Species == "Ophiodon elongatus"~ 1000,
                  10))
